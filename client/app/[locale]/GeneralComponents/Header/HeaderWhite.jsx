...
import logosvg from "./Icons/azuraworldsiyah1.svg"
...
export default function HeaderWhite() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 w-screen z-[99] items-center justify-center transition-all duration-500 ease-in-out ${
      ...
      >
        ...
        >
          ...
          <div className="flex md:hidden items-center justify-center h-full gap-[4px] ml-[75%] sm:ml-[80%] md:ml-[15px]">
            <span className="text-lagoBlack text-[16px] font-medium leading-[125%] uppercase -tracking-[0.352px] font-jost capsizedText4">
              <LangSwitcher />
            </span>
          ...
          {/* Ortadaki Logo (Kayma + taşma FIX) */}
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <Link className="pointer-events-auto flex items-center justify-center" href="/">
              <Image
                src={logosvg}
                alt="Logo"
                className="object-contain w-[70%] lg:w-[90%] max-w-[300px] max-h-[52px] md:max-h-[44px] lg:max-h-[60px]"
              />
            </Link>
          </div>
      ...
      >
        <div className="flex flex-col w-[98%] ml-[2%] h-full items-center justify-around py-[30px] lg:py-[15px] gap-[30px]">
          ...
          <nav className="items-center md:w-[90%] justify-center ml-2 mt-6 px-4 w-full lg:max-w-[392px] space-y-[10px] text-[16px] lg:text-[18px] text-lagoBlack font-jost uppercase min-h-[521px] md:h-[600px] overflow-y-auto black-scrollbar">
            <div className="relative">
              ...
              >
                <div className="mt-2 space-y-2 pl-4 font-jost">
                  <Link href="/rooms/" className="block text-[14px] leading-[29.639px] uppercase">
                    {t("allrooms")}
                  </Link>
                  <Link href="/rooms/deluxeroom" className="block text-[14px] leading-[29.639px] uppercase">
                    {t("deluxe")}
                  </Link>
                  ...
                  <Link href="/rooms/handicaproom" className="block text-[14px] leading-[29.639px] uppercase">
                    {t("handicap")}
                  </Link>
                </div>
              </div>
            ...
            <Link href="/entertainment" className="block text-lagoBlack font-normal leading-normal w-[70%] md:w-[90%] lg:max-w-[360.114px] py-[11px] border-b border-b-[#000000] lg:border-none">
              {t("entertainment")}
            </Link>
          ...
          <div className="ml-2 px-4 w-full lg:max-w-[392px] flex flex-col items-center font-jost">
            <div className="flex items-center justify-center gap-[15px] text-lagoBlack">
              ...
              <span className="text-[15px] font-normal leading-[24px]">0242 212 17 41</span>
            </div>
            ...
            <button
              ...
              className="
                ...
                mt-[20px]
                w-[253px] h-[42px]
                bg-[#181818] text-white uppercase text-center font-semibold
                hover:bg-gray-800
                leading-[24px]
                py-[15px] px-[19px]
              "
