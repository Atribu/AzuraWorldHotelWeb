    ...
    >
      <div className="flex flex-col md:flex-row-reverse w-[87.79%] md:w-[91.4%] lg:w-[76.8%] items-center justify-center gap-[30px] md:gap-[42px] lg:gap-[52px] h-full">
        ...
        <div className="flex w-[65%] min-w-[310px] md:w-[50%] h-[327px] md:h-full lg:w-[48.8%] items-end justify-end relative mt-[67px] md:mt-0">
          {/* SOLDa kalan / arkadaki resim (img2) - WRAPPER boyut verir */}
          <div
            className={`absolute bottom-[100px] right-[140px] md:bottom-[110px] md:right-[104px] lg:bottom-[105px] lg:right-[215px]
              w-[175px] h-[260px] md:w-[186.60px] md:h-[279.91px] lg:w-[300px] lg:h-[450px]
              z-10 transition-all duration-1000 ease-in-out will-change-transform transform-gpu ${
          ...
          >
            <Image
              ...
              fill
              quality={90}
              sizes="(min-width: 1024px) 300px, (min-width: 768px) 187px, 175px"
          ...
          <div
            className={`relative
              w-[175px] h-[260px] md:w-[186.60px] md:h-[279.91px] lg:w-[300px] lg:h-[450px]
              z-50 transition-all duration-1000 ease-in-out will-change-transform transform-gpu ${
